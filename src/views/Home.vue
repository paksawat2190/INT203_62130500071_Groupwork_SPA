      ...
      <div class="w-screen h-full">
        <div class="container">
          <div class="survey-container">
            <img class="pl-24" src="https://i.kym-cdn.com/photos/images/newsfeed/000/913/683/d76.jpg"/>
          <form @submit.prevent="submitForm">
            <text-box>
              ...
              <p v-if="invalidNameInput" class="text-red-500">
               ♥♥♥ Please, Enter your FanClub's NAME !!! ♥♥♥
              </p>
            </text-box>
            ...
            <text-box>
              <h2 class="heading">
              Do you think Doraemon is the most cartoon character?  
              </h2>
            ...
            <text-box>
              <h2 class="heading">
               Do you love or like Doraemon more than Doraeme
              </h2>
            ...
            <text-box>
              <h2 class="heading">
                Do you think Doraemon is the cat robot
              </h2>
